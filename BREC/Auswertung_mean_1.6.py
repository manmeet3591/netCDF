...
for i in range (1850, 2010):
   ...
   # t_ips_1_fields = dataset.createVariable('t_ips_1_field', numpy.float32,('time'))
    ...
    # set units
   # attrs_vars = [t_cya,t_lpp,t_spp,t_nh4,t_no3,t_po4,t_zoo,t_ipw,t_det,t_don, t_sed_1, t_ips_1]
   # attrs_vert = [t_cya_verts,t_lpp_verts,t_spp_verts,t_nh4_verts,t_no3_verts,t_po4_verts,t_zoo_verts,t_ipw_verts,t_det_verts,t_don_verts]
   # attrs_field = [t_cya_fields,t_lpp_fields,t_spp_fields,t_nh4_fields,t_no3_fields,t_po4_fields,t_zoo_fields,t_ipw_fields,t_det_fields,t_don_fields, t_sed_1_fields, t_ips_1_fields]
   # i = 0   
