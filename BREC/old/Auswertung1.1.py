...
for i in range (1850, 2009):
    ...
    t_cya_fields = dataset.createVariable('t_cya_field', numpy.float64,('time'))
    t_lpp_fields = dataset.createVariable('t_lpp_field', numpy.float64,('time'))
    t_spp_fields = dataset.createVariable('t_spp_field', numpy.float64,('time'))
