...
for i in range (1850, 1851):
    ...
    t_cya_int = numpy.empty(numpy.shape(t_cya),dtype='float32')
    t_lpp_int = numpy.empty(numpy.shape(t_lpp),dtype='float32')
    t_spp_int = numpy.empty(numpy.shape(t_spp),dtype='float32')
    ...
    #        t_cya_int[j,i,:,:] = t_cya[j,i,:,:]*dzt[j,i,:,:]*area_t[:,:]
    #        t_lpp_int[j,i,:,:] = t_lpp[j,i,:,:]*dzt[j,i,:,:]*area_t[:,:]
    #        t_spp_int[j,i,:,:] = t_spp[j,i,:,:]*dzt[j,i,:,:]*area_t[:,:]
